...
<script type="text/javascript">
	...
	function start() {
		...
		$.ajax({
			type: "POST",
			url: "<?php echo __PS_BASE_URI__; ?>modules/nqgatewayneteven/script/import-order.php",
		...
		$.ajax({
			...
			.done(function (jsonData) {
				...
				if (step >= jsonData.step) {
					...
					step = jsonData.step;
					$("#centerBlock").append('<tr><td style="background: #f3db2e" id="step_' + step + '" style="border: solid 1px gray;">' +
							jsonData.message + '</td></tr>')
				}
...
<table id="centerBlock">
	<tr>
		<td style="font-weight: bold; background: #2fd1ff">Import des commandes</td>
	</tr>
</table>
</body>